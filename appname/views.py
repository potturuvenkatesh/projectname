...
from appname.models import Order
...
def update(request, id):
	...
	if form.is_valid():
		form.save()
		return redirect('appname:Orders')
...
from .forms import ProductForm, OrdervForm
...
def order(request, id):
    ...
    form = OrdervForm(request.POST or None, instance = obj)
